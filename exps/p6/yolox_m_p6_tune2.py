...
from yolox.exp import CustomP6Exp


class Exp(CustomP6Exp):
    def __init__(self):
        super(Exp, self).__init__()
        self.depth = 0.67
        self.width = 0.75
        self.exp_name = os.path.split(os.path.realpath(__file__))[1].split(".")[0]
        self.exp_name += "_tune3"
        self.act = 'silu'

        self.init_ckpt = "pre_m_p6_tune.pth"

        # --------------- model config ----------------- #
        self.bn_momentum = 0.01  # reduced 0.03 -> 0.01
