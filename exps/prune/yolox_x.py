...
class Exp(MyExp):
    def __init__(self):
        ...
        self.exp_name += "_prune7"

        self.init_ckpt = "yolox_x.pth"
        ...
        self.shear = 2.0
        self.enable_mixup = False  # no mix-up

        # --------------- model config ----------------- #
        self.bn_momentum = 0.015  # 0.03 -> 0.03 (accum 2 -> 0.03)

        # ---------------- dataloader config ---------------- #
        self.multiscale_range = (-5, 4)  # to avoid too heavy memory cost
        ...
        self.max_epoch = 50
        self.warmup_lr = 0.001  # final ended lr of scratch
        ...
        # -------------- pruning config --------------------- #
        self.prune_channels = 100  # remove 0.5% of channels per each pruning step
        self.prune_interval = 0.101  # epoch
        self.prune_start_epoch = 0  # epoch
        self.distill_coefficient = 0.01  # global distill coefficient

        # self.prune_interval = 0.01  # epoch
        # self.prune_start_epoch = 0  # epoch
        # self.distill_coefficient = 0.0  # global distill coefficient
