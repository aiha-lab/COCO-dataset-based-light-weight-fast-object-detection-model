...
from yolox.models.network_blocks import ChannelMaskLayer, BaseConv, BaseConvWithMask
from yolox.utils.model_utils import replace_conv

from .base_exp import BaseExp


class SynFlowExp(BaseExp):
    def __init__(self):
        super().__init__()
    ...
    def get_model(self, bn_momentum: float = 0.03):
        ...
        replace_conv(self.model.backbone)  # only backbone
