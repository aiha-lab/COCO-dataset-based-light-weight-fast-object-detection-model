...
from .preprocess_utils import yolov5_load_one_image_pil, yolov5_collate_batch

IMG_EXT = ['bmp', 'jpg', 'jpeg', 'png', 'tif', 'tiff', 'dng']  # acceptable image suffixes

__all__ = ["YOLOv5ImageFolderDataset", "YOLOv5DataLoader"]


class YOLOv5ImageFolderDataset(Dataset):
    ...
    def __getitem__(self, idx):
        img, (h, w, img_file, new_h, new_w) = yolov5_load_one_image_pil(self.img_size, self.data_dir, self.img_files[idx])
...
class YOLOv5DataLoader(DataLoader):
    ...
    def __init__(self, *args, img_size: int, **kwargs):
        collate_fn = partial(yolov5_collate_batch, img_size)
